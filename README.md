...
![Build Status](https://github.com/JEANAWAH/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)

This project implements a microservice for managing customer accounts...
